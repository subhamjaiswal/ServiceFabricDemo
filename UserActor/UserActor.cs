...
namespace UserActor
{
    ...
    internal class UserActor : Actor, IUserActor
    {
        ...
        {
            await StateManager.AddOrUpdateStateAsync(productId.ToString(), quantity,
        ...
        public async Task ClearBasket()
        {
            ...
            foreach(string producid in ProductIds)
            {
                await StateManager.RemoveStateAsync(producid);
            }
        }
        ...
        public async Task<Dictionary<Guid, int>> GetBasket()
        {
            ...
            foreach(var productid in ProductIds)
            {
                ...
                result.Add(new Guid(productid), quantity);
            }
            return result;
